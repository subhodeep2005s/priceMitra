...
export default async function Home() {
  ...
  return (
    <main className="max-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50 ">
      <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 sticky z-10 top-0  ">
